...
state/               volatile runtime signals; gitignored
  ...
  terminal-outcomes/ private inactive-terminal receipts; pending main-home records close only through generation-bound wake acknowledgement, while secondmate records close only after parent-route append; bin/fm-inactive-reconcile-lib.sh
