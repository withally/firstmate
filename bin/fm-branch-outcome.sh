...
usage() {
  echo "usage: fm-branch-outcome.sh append --task <id> --verdict routine|captain|firstmate-action --summary <text> [--wake <text>] [--silent true|false] | unread | mark-read --through <seq> | list [--recent <n>] | startup-replay" >&2
  exit 2
}
