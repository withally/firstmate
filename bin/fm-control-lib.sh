...
# Which task kinds an adapter is verified to run. The control plane asks this BEFORE it
...
# Prints the key or nothing; a harness with no verified mechanics returns
