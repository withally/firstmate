...
The default threshold is 300 seconds; parent receipts and queued-key deduplication suppress repeats for the same row across watcher and handling crashes, while empty queues, younger rows, and ordinarily aged rows beside a fresh beat remain silent.
