...
While away mode is active, the identity-matched daemon lock rather than the watcher lock is the proof of supervision for the turn-end guard and the session-start digest, because the watcher lock is legitimately absent between wakes.
