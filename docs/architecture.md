...
A durable `captain-held` transfer earns the same bounded absorb, and both declarations hold regardless of agent liveness: the declaration is the crew's own positive idle-by-design statement, and an active run-step or busy pane still outranks it.
