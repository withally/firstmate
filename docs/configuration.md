...
FM_SECONDMATE_WAKE_STALL_SECS=300  # minimum foreign wake-row age before a stale same-home watcher beat produces one durable parent stall notification; a row over three times this age notifies despite a fresh beat; zero or invalid values use 300
