...
FM_ATTENDED_ROUTINE_STATUS_ABSORB=on   # attended watcher override for conservative routine-status absorption; exact off disables it, invalid values fail toward waking
