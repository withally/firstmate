...
A durable handled acknowledgement stops future re-announcement, while a record already queued remains under the durable queue's authority until the handling turn acknowledges the presented generation.
