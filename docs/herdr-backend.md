...
The separate routed-request carrier begins with `[fm-from-firstmate]` plus U+2063, and worker-bound requests append the recipient-aware silence suffix owned by `bin/fm-operational-input.sh`.
