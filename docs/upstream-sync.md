...
| 2026-08-28 | `b19924f` (`origin/main`) restore-on-demand | `b19924f` | restore-on-demand | Kept `7557d9a` locally because `upstream/main` still lacks the tracked Grok watcher long-runner and upstream #2914 remains pending; this is a deliberate temporary fork delta for the next weekly sync to re-audit, not a new upstream snapshot. |
