...
| 2026-08-29 | `1fd7ea2` (`upstream/main`) | `ca6ca85238435974d00034f9f4a064aa0f5fa677` | weekly | Re-cut the fork at upstream #3210. Re-applied #67, #70, #71, #72, #73, #75, #79, #80, and #81; restored #77's sync spine and companion edits. #67 remains fork-only because upstream #3155 carries declared waits and enriched wedge reasons but not the cadence guarantee across pane churn, status appends, and watcher restarts. Downgraded #68 and #69 for this cutover because preserving their old pending-reply implementation and fixture would require a lane-architecture reimplementation beyond conflict resolution. The shortlisted verified-merge-outcome and duplicate-Pi-outcome behaviors had no matching audited fork PR and were already present upstream via #3064 and #3184, respectively. |
| 2026-09-04 | `1b0fbb9b8693` (`upstream/main`) | `35c2965c5419ec66dbb8cabdddcfd833b61815e1` | weekly | Re-applied #70, #71, #72, #73, #75, #79, #80, #81, #84, #85, #86, #87, #88, #89, #90, #91, #92, #93, #94, #95, #96, #97, #98, #99, #100, #102, #103, #104, #105, #106, #107, #108, #109, and #110; restored #77's sync spine and companion edits. #67 was superseded by upstream #3532, which now carries the declared-wait cadence and enriched wedge reasons. #82 is no longer needed because #90 restores the required beat-aware secondmate behavior independently. #101 was superseded by upstream #3592. Upstream PRs #3591, #3593, and #3594 remain open, so their corresponding fork behaviors were judged against `upstream/main` and retained where still absent. The shortlisted verified-GitHub-merge-outcome and duplicate-Pi-captain-outcome behaviors had no matching audited fork PR and were already present upstream via #3064 and #3184, respectively. |
