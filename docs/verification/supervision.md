...
The same suite covers decision-only recovery, interrupted handling, stale acknowledgement rejection, process-event first refusal, and a persistent successor remaining live after recovery is acknowledged.
