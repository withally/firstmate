...
On 2026-09-02 the same suite, the strict typecheck, and the credential-free real-SDK guard were rerun against `@earendil-works/pi-coding-agent` 0.84.4 for the now-historical streaming delivery contract; [`runtime-backends.md`](runtime-backends.md#2026-09-02-historical-streaming-time-watcher-delivery) owns the exact commands and output.
